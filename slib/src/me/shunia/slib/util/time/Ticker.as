package me.shunia.slib.util.time
{
	...
	import me.shunia.slib.util.SimpleObjectPool;
	...
	public class Ticker
	{
		...
		public static function anim(time:int, target:Object):ITickerAnim {
			...
			anim.time = time;
			anim.target = target;
			tick(1, anim.onRender, 0, true);
			var obj:Object = _tickers[anim.onRender];
			obj.callbackEllapsedTime = true;
			anim.seq = obj;
			return anim;
		}
		
		public static function tick(time:int, callback:Function, repeat:int = 1, useFrame:Boolean = false):void {
